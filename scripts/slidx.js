...
$(document).ready(function () {
    ...
    //------------------------------  CONFIGURACIÓN  -------------------------------//
    var button = '#nav-toggle'; //Elemento en el que pulsamos para abrir y cerrar el menú. formerly: '#slidx_button'
    ...
    var opacity = 0.85; //Opacidad de la sombra que se crea en el resto de la página con el menú abierto. (0=transparente 1=opaco)
